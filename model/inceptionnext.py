...
def inceptionnext_base_384(pretrained=False, **kwargs):
    ...
    # model.load_state_dict(torch.load("./model/inceptionnext_base_384.pth"))
...
if __name__ == '__main__':
    ...
    net = inceptionnext_base()
    net.to(device=device)
    # net.load_state_dict(torch.load("inceptionnext_base_384.pth", map_location=device))
    input = torch.randn(1, 3, 256, 256).cuda()
    out, feature = net(input)
    print(out.shape)